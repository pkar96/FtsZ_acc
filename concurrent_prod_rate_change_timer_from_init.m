...
% rate is different before and after constriction. At certain time, there 
% is over expression of the division protein. The production rate of 
% division protein changes and the constriction time changes but the 
% the threshold to which the division protein is accumulated at 
% constriction remains constant.
...
is0 = 0.013; % initial overprodution
ds0 = 2.2; % new production rate of FtsZ at ch_cd time
time_dly = 18; % time delay from ch_cd before FtsZ production rate changes
s0 = s0+is0; sorig = s0;
